...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      let gl2: any = canvas.getContext('webgl2', params);
      const isWebGL2 = !!gl2;
      if (!isWebGL2)
        gl2 = canvas.getContext('webgl', params) || canvas.getContext('experimental-webgl', params);
    ...
    function getSupportedFormat(gl2: any, internalFormat: any, format: any, type: any): any {
    ...
    function supportRenderTextureFormat(gl2: any, internalFormat: any, format: any, type: any) {
    ...
    // Event handlers - matching React Bits original
